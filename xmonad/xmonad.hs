...
---CONFIG
------------------------------------------------------------------------
myFont          = "xft:Share Tech Mono:style=Regular:pixelsize=12"
...
myKeys =
    ...
    --- Dmenu (ALT+STRG+Key)
        , ("M-S-<Return>", spawn "dmenu_run -fn 'ShareTechMono-Regular:size=10' -nb '#444444' -nf '#71a5d2' -sb '#71a5d2' -sf '#444444' -p 'CMD:'")
