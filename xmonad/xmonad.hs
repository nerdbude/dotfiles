...
---CONFIG
------------------------------------------------------------------------
myFont          = "xft:ShureTechMono Nerd Font:style=Regular:pixelsize=11"
...
main = do
    ...
    xmonad $ ewmh desktopConfig
        ...
        , logHook = dynamicLogWithPP xmobarPP
                        ...
                        , ppHiddenNoWindows = xmobarColor "#262626" ""        -- Hidden workspaces (no windows)
                        , ppTitle = xmobarColor "#d700ff" "" . shorten 80     -- Title of active window in xmobar
                        , ppSep =  "<fc=#5fffd7> >> </fc>"                     -- Separators
                        , ppUrgent = xmobarColor "#262626" "" . wrap "!" "!"  -- Urgent workspace
